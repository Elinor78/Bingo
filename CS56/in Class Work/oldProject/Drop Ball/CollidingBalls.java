...
public class CollidingBalls extends JApplet implements Runnable, MouseListener{
    ...
    public void run(){
        ...
        while(true){
            ...
            try{
                ...
                this.mDetector.sleep(10);
            }catch(InterruptedException e){}

            Ball.handleCollision(this.mBalls, this.mIndex);
        }
    }
//============================================================================//
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(this.mIndex < (this.SIZE - 1)){
            ...
            if(this.mIndex == 1){
                ...
                this.mDetector = new Thread(this);
