...
public class RestDB extends AbstractTableModel implements Subject, Observer, NotifyConstants
{
    ...
    static final String DBURL = "jdbc:mysql://localhost/restaurants"; // May need changing
    ...
    public void connectToDB()
    {
        ...
        try
        {
            ...
            connection = DriverManager.getConnection( DBURL, "ducky", "ittle" );
